...
VL_ATTR_COLD void VANDgate___024root___eval_initial(VANDgate___024root* vlSelf) {
...
#endif
            VL_FATAL_MT("ANDgate.v", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (VANDgate___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void VANDgate___024root___dump_triggers__ico(VANDgate___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VANDgate___024root___dump_triggers__ico\n"); );
    VANDgate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VANDgate___024root___dump_triggers__nba(VANDgate___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VANDgate___024root___dump_triggers__nba\n"); );
    VANDgate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
